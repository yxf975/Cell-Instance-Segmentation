...
work_dir = f'./work_dirs/SwinPretrain'
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'train_shsy5y.json',  # Modified
        img_prefix=data_root + 'images/livecell_train_val_images/',  # Modified
        classes=classes,  # Added
        pipeline=train_pipeline),
    val=dict(
        type=dataset_type,
        ann_file=data_root + 'val_shsy5y.json',  # Modified
        img_prefix=data_root + 'images/livecell_train_val_images/',  # Modified
        classes=classes,  # Added
        pipeline=test_pipeline),
    test=dict(
        type=dataset_type,
        ann_file=data_root + 'test_shsy5y.json',  # Modified
